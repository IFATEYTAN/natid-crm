...
2. [ניהול לקוחות](#ניהול-לקוחות--customers)
3. [פרטי לקוח](#פרטי-לקוח--customerdetails)
4. [עריכת לקוח](#עריכת-לקוח--editcustomer)
5. [פורטל לקוח — מעקב קריאה](#פורטל-לקוח--מעקב-קריאה--customerportal)
6. [ניהול משובי לקוחות](#ניהול-משובי-לקוחות--feedbackmanagement)
7. [טופס משוב לקוח](#טופס-משוב-לקוח--customerfeedback)
8. [דוחות — דוח שנתי](#דוחות--דוח-שנתי--reports)
9. [דוח שימושים](#דוח-שימושים--callusagereport)
10. [ניתוח נתונים היסטוריים](#ניתוח-נתונים-היסטוריים--historicaldataanalysis)
11. [ייבוא נתונים היסטוריים](#ייבוא-נתונים-היסטוריים--importhistoricaldata)
12. [ייצוא מתקדם](#ייצוא-מתקדם--advancedexport)
13. [ניהול יעדים (KPI)](#ניהול-יעדים-kpi--kpimanagement)
14. [חשבוניות](#חשבוניות--invoices)
15. [קטלוג מוצרים](#קטלוג-מוצרים--productcatalog)
16. [חבילות סוכני ביטוח](#חבילות-סוכני-ביטוח--insuranceagentpackages)
...
- טווח תאריכים.
- סטטוס קריאה: הכל / ממתין לטיפול / ממתין לשיבוץ / ספק שובץ / ספק בדרך / בטיפול / סגור / בוטל.
...
*מדריך זה הוא חלק מסדרת המדריכים למשתמש של NatID 360 Control. למדריכים נוספים ראו את תיקיית `docs/guides`.*
