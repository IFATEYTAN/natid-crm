...
3. **דוחות מפורטים** — ממתינים לאפיון: דוח איחורים, דוח דירוגים, דוח ביצועים, דוח חשבוניות מאושרות.

4. **ספק לא יכול להעביר קריאה** — אם הספק לא מצליח לטפל בקריאה שכבר קיבל, אין מנגנון להחזיר/להעביר לספק אחר.

### עדיפות בינונית 🟡

5. **זיהוי חפיפת קריאות** — ספק יכול לקבל 2 קריאות באותו זמן. אין בדיקה אם כבר יש קריאה פעילה.

6. **סטטוס "לא ניתן לטיפול"** — חסר סטטוס ביניים כשספק הגיע אבל לא יכול לטפל.

7. **תזמון חכם** — Calendar קיים אבל חסר: התנגשויות תזמון, תזמון אוטומטי לפי עומס.

8. **ספים וטריגרים להתראות** — ממתינים להגדרות: כמה זמן לפני שמתריעים על איחור, SLA חורג. ווידג'ט חיזוי AI קיים אך אין אסקלציה אוטומטית.
