      ...
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
        ...
        <Tabs defaultValue="customer" dir="rtl">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <FieldRow label="ימי אחסנה">
                <Input
                  ...
                  onChange={(e) =>
                    set('storage_days', e.target.value ? Number(e.target.value) : null)
                  }
                />
              </FieldRow>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <FieldRow label="מרחק ק״מ">
                <Input
                  ...
                  onChange={(e) =>
                    set('estimated_distance_km', e.target.value ? Number(e.target.value) : null)
                  }
                />
              </FieldRow>
            </div>
          ...
          <TabsContent value="technical" className="space-y-3 mt-4">
            <BoolField
              label="גישה מלאה למשאית גרר"
              checked={form.is_road_accessible}
              onCheckedChange={(v) => set('is_road_accessible', v)}
            />
            <BoolField
              label="חניון תת קרקעי/מקורה"
              checked={form.is_underground_parking}
              onCheckedChange={(v) => set('is_underground_parking', v)}
            />
            <BoolField
              label="ידית ההילוכים על N"
              checked={form.is_gear_neutral}
              onCheckedChange={(v) => set('is_gear_neutral', v)}
            />
            <BoolField
              label="ההגה נעול"
              checked={form.is_steering_locked}
              onCheckedChange={(v) => set('is_steering_locked', v)}
            />
            <BoolField
              label="בלם יד משוחרר"
              checked={form.is_handbrake_released}
              onCheckedChange={(v) => set('is_handbrake_released', v)}
            />
            <BoolField
              label="כביש אגרה"
              checked={form.is_toll_road}
              onCheckedChange={(v) => set('is_toll_road', v)}
            />
            <BoolField
              label="לקוח ליד הרכב"
              checked={form.is_customer_with_vehicle}
              onCheckedChange={(v) => set('is_customer_with_vehicle', v)}
            />
            <BoolField
              label="יש מפתח"
              checked={form.has_key}
              onCheckedChange={(v) => set('has_key', v)}
            />
            <BoolField
              label="לקוח VIP"
              checked={form.is_vip}
              onCheckedChange={(v) => set('is_vip', v)}
            />
          </TabsContent>
          ...
          <TabsContent value="payment" className="space-y-3 mt-4">
            <div className="grid grid-cols-2 gap-3">
              <FieldRow label="עלות לספק (לפני מע״מ)">
                <Input
                  ...
                  onChange={(e) =>
                    set('cost_to_vendor', e.target.value ? Number(e.target.value) : null)
                  }
                />
              </FieldRow>
              <FieldRow label="סכום מהלקוח">
                <Input
                  ...
                  onChange={(e) =>
                    set('payment_amount_customer', e.target.value ? Number(e.target.value) : null)
                  }
                />
              </FieldRow>
            ...
            <BoolField
              ...
              onCheckedChange={(v) => set('payment_required', v)}
            />
          </TabsContent>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <FieldRow label="יעד SLA (דקות)">
                <Input
                  ...
                  onChange={(e) =>
                    set('sla_target', e.target.value ? Number(e.target.value) : null)
                  }
                />
              </FieldRow>
            </div>
