...
const contextualTips = {
  ...
  Calendar: [
    ...
    {
      title: 'קודי צבע',
      text: 'הצבעים מייצגים סטטוס: ירוק=סגור, צהוב=בביצוע, אדום=דחוף, אפור=ממתין.',
    },
  ],
  QueueMonitor: [
    ...
    <>
      ...
      >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex bg-white rounded-full border border-red-200 overflow-hidden text-xs">
                    <button
                      ...
                      aria-pressed={mode === 'tips'}
                      className={`px-2 py-1 flex items-center gap-1 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 ${mode === 'tips' ? 'bg-red-600 text-white' : 'text-red-600 hover:bg-red-50'}`}
                    >
                    ...
                    <button
                      ...
                      className={`px-2 py-1 flex items-center gap-1 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 ${mode === 'chat' ? 'bg-red-600 text-white' : 'text-red-600 hover:bg-red-50'}`}
                    >
                  ...
                  <button
                    ...
                    aria-label="סגור"
                    className="text-gray-400 hover:text-gray-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 rounded"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
                  ...
                  <div className="flex items-center justify-between px-4 py-2 border-t border-gray-100">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-1 rounded hover:bg-gray-100 disabled:opacity-30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
                      >
                        <ChevronRight className="w-4 h-4" />
                      </button>
                      <div className="flex gap-1" role="tablist" aria-label="טיפים">
                        {tips.map((_, idx) => (
                          <button
                            key={idx}
                            ...
                            aria-label={`טיפ ${idx + 1} מתוך ${tips.length}`}
                            className={`w-1.5 h-1.5 rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 ${idx === currentTipIndex ? 'bg-red-500' : 'bg-gray-300'}`}
                          />
                        ))}
                      </div>
                      <button
                ...
                <>
                  ...
                  <div className="flex items-center gap-2 p-3 border-t border-gray-100 bg-white">
                    <input
                      ...
                      aria-label="הודעה לנתי"
                      className="flex-1 text-xs border border-gray-200 rounded-full px-3 py-2 outline-none focus:border-red-300 focus:ring-2 focus:ring-red-200"
                      dir="rtl"
                    />
                    <button
                      ...
                      aria-label="שלח"
                      className="w-8 h-8 bg-red-600 hover:bg-red-700 text-white rounded-full flex items-center justify-center disabled:opacity-40 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-300"
                    >
        ...
        <motion.button
          ...
          aria-label={isOpen ? 'סגור את העוזר נתי' : 'פתח את העוזר נתי'}
          aria-expanded={isOpen}
          className="w-16 h-16 rounded-full bg-white shadow-lg border-2 border-red-100 hover:border-red-300 flex items-center justify-center overflow-hidden transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400"
