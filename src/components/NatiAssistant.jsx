...
const contextualTips = {
  ...
  Dashboard: [
    {
      title: 'לוח הבקרה',
      text: 'כאן תראה סיכום של כל הפעילות - קריאות פתוחות, ביצועים וסטטיסטיקות בזמן אמת.',
    },
    {
      title: 'כרטיסי KPI',
      text: 'לחץ על כל כרטיס KPI כדי לעבור ישירות למסך הרלוונטי ולצלול לנתונים.',
    },
    {
      title: 'גרפים',
      text: 'הגרפים מציגים מגמות שבועיות וחודשיות. העבר עכבר מעל הנקודות לראות פירוט.',
    },
    {
      title: 'קריאות אחרונות',
      text: 'בתחתית העמוד תמצא את הקריאות האחרונות שנפתחו. לחץ על קריאה לפרטים מלאים.',
    },
  ],
  Calls: [
    {
      title: 'רשימת קריאות',
      text: 'כאן מנוהלות כל הקריאות במערכת. אפשר לסנן, לחפש ולמיין לפי כל עמודה.',
    },
    {
      title: 'סינון מתקדם',
      text: 'השתמש בפילטרים למעלה כדי למצוא קריאות לפי סטטוס, תאריך, ספק או אזור.',
    },
    {
      title: 'יצירת קריאה',
      text: 'לחץ על "קריאה חדשה" בתפריט הצד או בכפתור הראשי ליצירת קריאה חדשה.',
    },
    { title: 'ייצוא', text: 'אפשר לייצא את רשימת הקריאות ל-Excel לדוחות ומעקב.' },
  ],
  CallDetails: [
    {
      title: 'פרטי קריאה',
      text: 'כאן מוצגים כל הפרטים של הקריאה - מידע על הלקוח, סטטוס, היסטוריה ושיבוץ ספק.',
    },
    { title: 'ציר זמן', text: 'ציר הזמן מציג את כל ההיסטוריה של הקריאה - מרגע הפתיחה ועד הסגירה.' },
    {
      title: 'שיבוץ ספק',
      text: 'מכאן אפשר לשבץ ספק לקריאה, לשנות שיבוץ או לראות המלצות אוטומטיות.',
    },
    {
      title: 'תמונות ומסמכים',
      text: 'בלשונית המדיה ניתן לצפות בתמונות, חתימות ומסמכים שצורפו לקריאה.',
    },
  ],
  Calendar: [
    {
    ...
    { title: 'גרור ושחרר', text: 'אפשר לגרור קריאות בין תאריכים כדי לתזמן מחדש.' },
    {
      title: 'קודי צבע',
  ...
  NewCase: [
    { title: 'קריאה חדשה', text: 'מלא את כל השדות הנדרשים ליצירת קריאת שירות חדשה.' },
    {
      title: 'פרטי לקוח',
      text: 'התחל בבחירת לקוח קיים או יצירת לקוח חדש. המערכת תמלא פרטים אוטומטית.',
    },
    { title: 'סוג שירות', text: 'בחר את סוג השירות הנדרש - זה ישפיע על שיבוץ הספק האופטימלי.' },
    { title: 'דחיפות', text: 'הגדר רמת דחיפות - זה ישפיע על סדר העדיפות בתור.' },
  ],
  ...
  CoverageAreas: [
    ...
    { title: 'חורים בכיסוי', text: 'המערכת מסמנת אזורים ללא כיסוי ספקים כדי לזהות פערים.' },
  ],
  ...
  Customers: [
    ...
    { title: 'הוספת לקוח', text: 'לחץ "לקוח חדש" להוספת לקוח למאגר.' },
  ],
  CustomerDetails: [
  ...
  CustomerFeedback: [
    ...
    { title: 'מגמות', text: 'המערכת מנתחת מגמות בשביעות רצון ומציגה תובנות.' },
  ],
  ...
  NewVendor: [
    ...
    { title: 'אזורי כיסוי', text: 'הגדר את האזורים שהספק מכסה כדי שהמערכת תוכל לשבץ אותו.' },
  ],
  VendorContracts: [
  ...
  VendorCallManagement: [
    ...
    { title: 'תמונות', text: 'צלם תמונות לפני ואחרי הטיפול. חשוב לתיעוד ולדירוג.' },
  ...
  VendorGuide: [
    {
      title: 'מדריך לספקים',
      text: 'מדריך מלא לשימוש במערכת כספק - מההתחלה ועד ניהול קריאות מתקדם.',
    },
    { title: 'צעד אחר צעד', text: 'עקוב אחרי השלבים בסדר כדי ללמוד את המערכת בצורה הטובה ביותר.' },
  ],
  ...
  UserGuide: [
    {
      title: 'מדריך למשתמש',
      text: 'מדריך מקיף לשימוש במערכת - לחץ על כל נושא כדי לקרוא הסבר מפורט.',
    },
  ],
  LandingPage: [
    {
  ...
  // === Default for any unlisted page ===
  default: [
    {
      title: 'שלום! אני נתי',
      text: 'אני כאן לעזור לך להשתמש במערכת. לחץ על החצים כדי לראות טיפים.',
    },
    { title: 'עזרה', text: 'לחץ עליי בכל מסך כדי לקבל הסבר וטיפים רלוונטיים לדף שבו אתה נמצא.' },
    { title: 'המדריך המלא', text: 'רוצה ללמוד את כל המערכת? לחץ על "מדריך למשתמש" למטה.' },
  ],
};
...
export default function NatiAssistant() {
  ...
  return (
    <div className="fixed bottom-4 left-20 z-[100]" dir="rtl">
      {/* Speech Bubble */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
