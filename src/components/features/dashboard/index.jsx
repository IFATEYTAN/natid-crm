...
export default function DashboardPage() {
  ...
  const callsQuery = useQuery({
    queryKey: queryKeys.calls.list({ sort: '-created_date', limit: 500 }),
  ...
  const availableVendors = availableVendorsQuery.data || [];
        ...
        <TabsContent value="operator" className="space-y-6 mt-6 focus-visible:outline-none">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="lg:col-span-1">
              ...
              <CardContent>
                <QueryStateWrapper query={availableVendorsQuery}>
                  <DataTable
                    columns={vendorColumns}
                    data={availableVendors}
                    isLoading={availableVendorsQuery.isLoading}
