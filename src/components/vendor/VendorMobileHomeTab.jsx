...
import {
  Phone, MapPin, Navigation, ArrowLeft, CheckCircle,
  Clock, AlertCircle, PhoneCall, Truck,
} from 'lucide-react';
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="text-start">
            ...
            <div className="text-white/80 text-sm">{isAvailable ? 'מקבל קריאות חדשות' : 'לחץ להפעלה'}</div>
          </div>
        </div>
        <div className={cn(
