...
import { Home, Phone, Map, User } from 'lucide-react';

const TABS = [
  { id: 'home', label: 'בית', Icon: Home },
  { id: 'calls', label: 'קריאות', Icon: Phone },
  { id: 'map', label: 'מפה', Icon: Map },
  { id: 'profile', label: 'פרופיל', Icon: User },
];

export default function VendorMobileNav({ activeTab, onTabChange, activeCallsCount }) {
  return (
