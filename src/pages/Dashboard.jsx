...
const OperatorTab = lazy(() => import('@/components/dashboard/OperatorTab'));
const CasesTab = lazy(() => import('@/components/dashboard/CasesTab'));
const TotalsTab = lazy(() => import('@/components/dashboard/TotalsTab'));
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full" dir="rtl">
        ...
        <TabsContent value="totals" className="space-y-6 mt-6 focus-visible:outline-none">
          <Suspense fallback={<Skeleton className="h-64" />}>
            <TotalsTab
              filteredTotalsCalls={filteredTotalsCalls}
              handleExportTotals={handleExportTotals}
