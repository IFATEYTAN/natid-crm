...
const callLifecycleSteps = [
  ...
  },
  {
    icon: Navigation,
    title: 'יצאתי לדרך',
    desc: 'לחץ "יצאתי לדרך" - הסטטוס מתעדכן ל"נותן השירות בדרך ללקוח" והמוקד רואה זאת בזמן אמת. השתמש בכפתור Waze לניווט ישיר למיקום.',
  ...
  },
  {
    icon: Pencil,
    title: 'חתימה וסיום',
    desc: 'חובה לקבל חתימה דיגיטלית מהלקוח לפני סיום! לחץ "חתימת לקוח" ← "סיים קריאה". הקריאה עוברת ל"סגור". אם הקריאה הושלמה - תתבקש לתת משוב.',
...
const faqData = [
  ...
  },
  {
    ...
    a: 'בעמוד הפורטל מופיע סיכום חודשי: קריאות שנסגרו, הכנסה משוערת. תשלומים מעובדים בסוף כל חודש לפי חוזה.',
  },
  {
  ...
  },
  {
    ...
    a: 'שובץ → בדרך (יצאתי לדרך) → בטיפול (הגעתי למקום) → סגור (סיימתי + חתימה). כל שלב מתועד אוטומטית.',
  },
  {
